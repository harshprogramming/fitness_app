  ...
  Widget build(BuildContext context) {
    return AppScope(
      ...
      child: MaterialApp(
        ...
        routes: {
          '/': (_) =>
              _Root(index: _index, onIndex: (i) => setState(() => _index = i)),
          '/workout/new': (_) => const WorkoutFormScreen(),
          '/workout/edit': (ctx) {
            final w = ModalRoute.of(ctx)!.settings.arguments as Workout;
            return WorkoutFormScreen(existing: w);
          },
          '/calories': (_) => const CaloriesScreen(),
          '/routines': (_) => const RoutinesScreen(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
              icon: Icon(Icons.restaurant_outlined), label: 'Calories'),
          NavigationDestination(
